...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmFqa2FtYWxjaCIsImEiOiJjamhpeDEwb3kyOGJrMzBuMjd5bnF1ZDh6In0.y2OEd_nvqAOpbo2qYaXhxw';
...
}; // const locations = JSON.parse(document.querySelector('#map').getAttribute('data-locations'));
...
var stripe = Stripe('pk_test_51HJIBlJiLJSNl1xZI1SbyBllhoLvNFIonRzVBadRkNBSWcjnq09VTlUSg6JHkS7LVfA8SpyA9aGm7zeHuYjtowfn0028Hjg2mJ');
...
var loginForm = document.querySelector('.btn--green');
